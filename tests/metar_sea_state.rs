...
fn parse_sea_state_standard() {
    ...
    let m = parse_metar(
        "METAR EKCH 120930Z 25010KT 9999 FEW020 12/08 Q1013 W12/S8",
    )
    .unwrap();
...
fn parse_sea_state_zero() {
    ...
    let m = parse_metar(
        "METAR EKCH 120930Z 25010KT 9999 FEW020 01/M01 Q1013 W00/S0",
    )
    .unwrap();
...
fn parse_sea_state_negative_temperature() {
    ...
    let m = parse_metar(
        "METAR ENBO 120930Z 10005KT 9999 FEW020 M01/M04 Q1008 WM2/S3",
    )
    .unwrap();
...
fn parse_sea_state_height_dm() {
    ...
    let m = parse_metar(
        "METAR EKCH 120930Z 25010KT 9999 FEW020 18/14 Q1013 W18/H25",
    )
    .unwrap();
...
fn parse_sea_state_not_available() {
    ...
    let m = parse_metar(
        "METAR EKCH 120930Z 25010KT 9999 FEW020 12/08 Q1013 W//S/",
    )
    .unwrap();
