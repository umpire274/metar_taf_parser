...
fn taf_icing_light_parsed() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 610304",
    )
    .unwrap();
...
fn taf_icing_severe_parsed() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 640502",
    )
    .unwrap();
...
fn taf_icing_none_intensity() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 600003",
    )
    .unwrap();
...
fn taf_no_icing_by_default() {
    let taf = parse_taf(
        "TAF LIRF 121100Z 1212/1318 18010KT 9999 SCT020",
    )
    .unwrap();
...
fn taf_multiple_icing_layers() {
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 610304 620502",
    )
    .unwrap();
...
fn taf_turbulence_light_parsed() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 510304",
    )
    .unwrap();
...
fn taf_turbulence_moderate_in_cloud() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 520803",
    )
    .unwrap();
...
fn taf_turbulence_extreme() {
    ...
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 560202",
    )
    .unwrap();

    assert_eq!(taf.forecasts[0].turbulence[0].intensity, TurbulenceIntensity::Extreme);
}
...
fn taf_icing_in_tempo_block() {
    let taf = parse_taf(
        "TAF KORD 121100Z 1212/1318 18010KT 9999 SCT020 TEMPO 1218/1222 4000 -RA 610304",
    )
    .unwrap();
